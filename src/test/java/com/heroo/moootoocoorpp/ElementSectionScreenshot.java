...
public class ElementSectionScreenshot {
	...
	public static void main(String[] args) throws  IOException  {
		...
		WebElement SectionScr = driver.findElement(By.xpath("//div[@class='help-main-wrapper']"));
	
		File src = SectionScr.getScreenshotAs(OutputType.FILE);
		File des = new File("C:\\Users\\Shashikant\\eclipse-workspace\\motocorpp\\src\\SectionSC\\sectionscc.png");
